                                ...
                                <div class="tab-pane active" id="settings">
                                    <div class="form-horizontal">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" name="first_name" class="form-control @error('first_name') is-invalid @enderror" placeholder="Имя" value="{{ $user->first_name }}">
                                                @error('first_name')<span class="error invalid-feedback">{{ $message }}</span>@enderror
                                            </div>
                                            <div class="col-sm-3">
                                                <input type="text" name="last_name" class="form-control @error('last_name') is-invalid @enderror" placeholder="Фамилия" value="{{ $user->last_name }}">
                                                @error('last_name')<span class="error invalid-feedback">{{ $message }}</span>@enderror
                                            </div>
                                            <div class="col-sm-4">
                                                <input type="text" name="second_name" class="form-control @error('second_name') is-invalid @enderror" placeholder="Отчество" value="{{ $user->second_name }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="login" class="form-control @error('login') is-invalid @enderror" id="inputName2" placeholder="Логин" value="{{ $user->login }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="phone_number" class="form-control @error('phone_number') is-invalid @enderror" placeholder="Телефон номер" value="{{ $user->phone_number }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="date" name="birthday" class="form-control @error('birthday') is-invalid @enderror" placeholder="Дата рождение" value="{{ $user->birthday?->format('Y-m-d') }}">
                                        ...
                                        <div class="form-group row">
                                            <div class="offset-sm-2 col-sm-10">
                                                <div class="checkbox">
                                                    <label>
                                                        <input name="active" type="checkbox" @if($user->active) value="1" checked="checked" @else value="0" @endif> Активность
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-10">
                                                <select multiple name="roles[]" class="form-control @error('roles') is-invalid @enderror">
                                                    @foreach($roles as $role)
                                                        <option value="{{ $role->name }}" @if($user->hasRole($role)) selected @endif>{{ $role->title }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            <div class="offset-sm-2 col-sm-10">
                                                ...
                                                <a href="{{ route('future.pages.users.edit', $user->id) }}" class="btn btn-sm btn-primary">Редактировать</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
