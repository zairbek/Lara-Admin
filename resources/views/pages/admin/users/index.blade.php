            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-tools float-left">
                        <a href="{{ route('future.pages.users.create') }}" class="btn btn-sm btn-primary" title="Добавить пользователя">Добавить пользователя</a>
                    </div>
                        ...
                        >
                            <div class="input-group-prepend">
                                <select name="field" class="btn btn-default dropdown-toggle">
                                    ...
                                    <option value='name' @if(request()->get('field') === 'name') selected @endif>Имя фамилия</option>
                                    <option value='email' @if(request()->get('field') === 'email') selected @endif>Email</option>
                                    <option value='roles' @if(request()->get('field') === 'roles') selected @endif>Группа</option>
                                </select>
                            </div>
