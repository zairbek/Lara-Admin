...
@section('title', "Редактирование: $permission->title")
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="settings">
                            <form class="form-horizontal"
                                  action="{{ route('future.pages.settings.permissions.update', $permission->id) }}"
                                  method="post"
                            >
                                @method('put')
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" name="title"
                                               ...
                                               placeholder="Название" value="{{ $permission->title }}">
