                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="settings">
                            <form class="form-horizontal"
                                  action="{{ route('future.pages.settings.roles.store') }}"
                                  method="post"
                            >
                                @csrf
                                                ...
                                                <div class="checkbox">
                                                    <label>
                                                        <input name="permissions[{{ $permission->name }}]" type="checkbox"
                                                               @if(old('permissions') && isset(old('permissions')[$permission->name]) && old('permissions')[$permission->name] === 'on') checked="checked"
